    ...
    return (
        <Card className="hover:shadow-md transition-shadow">
            <CardContent className="p-4">
                ...
                <div>
                    <h4 className="font-semibold text-gray-900 text-sm mb-1">{appointment.client}</h4>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">Good morning! 👋</h1>
                    <p className="text-sm text-gray-500 mt-1">Monday, September 8, 2025</p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="hover:shadow-sm transition-shadow bg-white">
                    ...
                    <CardContent>
                        <div className="text-2xl sm:text-3xl font-bold text-gray-900">$2,840</div>
                        <p className="text-xs text-gray-500 mt-1">
                            +12% from yesterday
                        </p>
                    </CardContent>
                ...
                <Card className="hover:shadow-sm transition-shadow bg-white">
                    ...
                    <CardContent>
                        <div className="text-2xl sm:text-3xl font-bold text-gray-900">87%</div>
                        <p className="text-xs text-gray-500 mt-1">
                            +3% from yesterday
                        </p>
                    </CardContent>
                        ...
                        <CardContent className="pt-0">
                            ...
                            <div className="hidden sm:block space-y-3">
                                {todayAppointments.map((appointment) => (
                                    <div key={appointment.id} className="flex items-center justify-between p-3 rounded-lg border border-gray-100 hover:border-gray-200 transition-colors">
                                        <div className="flex items-center space-x-3">
